...
//         <h2 className="mb-5 mt-10">Login Here</h2>
...
//                         <input type={el} name={el} value={credentials[el]} onChange={handleChange} className="border border-[#BCB3B1] rounded-md w-md text-shadow-transparent"></input>
//                     </div>
//                 )
//             })}

//             <p>If You Do Not Have An Account Yet,
//                 <NavLink className="text-blue-800" to="/register">
//                     Register Here
//                 </NavLink>
//             </p>
        ...
        <div className="w-full max-w-md bg-white border border-[#BCB3B1]/40 p-8 rounded-2xl shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col">
                    ...
                    return (
                        <div key={el} className="flex flex-col mb-5">
                            ...
                            <input 
                                ...
                                placeholder={el === "email" ? "your.email@example.com" : "••••••••"}
                ...
                <p className="text-slate-500 text-xs text-center mt-2 mb-6">
                    ...
                    <NavLink className="text-[#988B7B] hover:text-[#988B7B]/80 font-bold underline transition-colors" to="/register">
                        Register Here
                    </NavLink>
                </p>
