// const Footer=()=>{
//     return <>
//         <footer className="bg-white font-lato shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1),0_-2px_4px_-1px_rgba(0,0,0,0.06)]">
//         <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
//         <div className="md:flex md:justify-between">
//           <div className="mb-6 md:mb-0">
//               <a href="https://flowbite.com/" className="flex items-center">
//                   <span className="text-heading self-center text-2xl font-semibold whitespace-nowrap">FairShare</span>
//               </a>
//           </div>
...
//                       <li className="mb-4">
//                           <a href="https://flowbite.com/" className="hover:underline">FairShare</a>
//                       </li>
//                       <li>
...
//           <span className="text-sm text-body sm:text-center">© 2026 <a href="https://flowbite.com/" className="hover:underline">FairShare™</a>. All Rights Reserved.
//           </span>
...
// Optional: Install lucide-react for icons, or use your own SVG/FontAwesome icons
...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-white border-t border-[#BCB3B1]/30 font-lato text-slate-600">
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 rounded-full bg-[#988B7B] flex items-center justify-center text-white font-bold">
                <DollarSign className="w-4 h-4" />
              </div>
              <span className="font-asul font-bold text-xl tracking-wide text-[#988B7B]">
                FairShare
              </span>
            </div>
            <p className="text-xs text-slate-400 leading-relaxed max-w-xs uppercase tracking-wider font-semibold">
              Elegantly split bills, manage group debts, and track mutual expenses without the headache.
            </p>
          </div>

          {/* Quick Links Column */}
          <div>
            <h4 className="font-asul font-bold text-sm text-[#988B7B] tracking-wider uppercase mb-4">
              Quick Links
            </h4>
            <ul className="flex flex-col gap-2.5 text-sm">
              <li>
                <NavLink to="/" className="hover:text-[#988B7B] hover:underline transition-all">
                  Home
                </NavLink>
              </li>
              <li>
                <NavLink to="/groups" className="hover:text-[#988B7B] hover:underline transition-all">
                  My Groups
                </NavLink>
              </li>
              <li>
                <NavLink to="/login" className="hover:text-[#988B7B] hover:underline transition-all">
                  Login
                </NavLink>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5 text-sm">
              <li>
                <NavLink to="/faq" className="hover:text-[#988B7B] hover:underline transition-all">
                  FAQs
                </NavLink>
              </li>
              <li>
                <NavLink to="/terms" className="hover:text-[#988B7B] hover:underline transition-all">
                  Terms of Service
                </NavLink>
              </li>
              <li>
                <NavLink to="/privacy" className="hover:text-[#988B7B] hover:underline transition-all">
                  Privacy Policy
                </NavLink>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5 text-sm mb-4">
              <li className="flex items-center gap-2">
                <Mail className="w-4 h-4 text-[#988B7B]" />
                <span className="text-xs">support@splitwise.com</span>
              </li>
              <li className="flex items-center gap-2">
                <MapPin className="w-4 h-4 text-[#988B7B]" />
        ...
        {/* Divider */}
        <hr className="border-[#BCB3B1]/20 my-6" />

        {/* Bottom Bar */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-400">
          <p>© {currentYear} FairShare App. All rights reserved.</p>
          <div className="flex gap-4">
            <span className="hover:text-[#988B7B] cursor-pointer">English (US)</span>
            <span>•</span>
            <span className="hover:text-[#988B7B] cursor-pointer">INR (₹)</span>
          </div>
        </div>
      </div>
    </footer>
